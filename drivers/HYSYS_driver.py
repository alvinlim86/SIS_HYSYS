...
def openHysys(hyFilePath):
    aspen_hysys_path = r'C:\Program Files\AspenTech\Aspen HYSYS V14.0\AspenHysys.exe'
    #hyApp = win32.Dispatch(aspen_hysys_path)
    hyApp = win32.Dispatch('HYSYS.Application.NewInstance.Runtime.V14.0')
    hyApp.Visible = True
...
if __name__ == "__main__":
    ...
    hyFilePath = r"C:\Users\alvin\Documents\AspenTech\test.tpl"
